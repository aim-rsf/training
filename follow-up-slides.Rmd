...
1. Go to the .white[[intros.md](https://github.com/aim-rsf/github-intro/blob/main/intros.md)] in the github-intro repository
...
10. Assign me (@eirini-zormpa) or Sophia (@BrainonSilicon) as a reviewer
